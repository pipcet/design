...
| [Stdlib](#stdlib-section) | `2` | Standard library function declarations |
...
The standard library section declares all standard library functions that will be used in, and are defined in, the module.
